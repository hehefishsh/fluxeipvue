      ...
      <div id="sidebar" class="sidebar sidebar-with-footer">
        ...
        <div class="sidebar-left" data-simplebar style="height: 100%">
          ...
          <ul class="nav sidebar-inner" id="sidebar-menu">
            ...
            <li class="has-sub expand" :class="{ active: /^\/requestform(\/.*)?$/.test(route.path) }">
              ...
              <ul class="collapse" id="requestform" data-parent="#sidebar-menu">
                <div class="sub-menu">
                  ...
                  <li :class="{ active: route.path === '/requestform/missingpunch' }">
                    <RouterLink class="sidenav-item-link" to="/requestform/missingpunch">
              ...
              <ul class="collapse" id="requestapproval" data-parent="#sidebar-menu">
                <div class="sub-menu">
                  ...
                  <li :class="{
                    ...
                    <RouterLink class="sidenav-item-link" to="/requestapproval/workadjust">
            ...
            <!-- 有的子目錄的導引欄--申請表單查詢 -->
            <li class="has-sub expand" :class="{ active: /^\/approvalflow(\/.*)?$/.test(route.path) }" v-if="
            ...
            <li class="has-sub expand" :class="{ active: /^\/meeting(\/.*)?$/.test(route.path) }">
              ...
              <ul class="collapse" id="meeting" data-parent="#sidebar-menu">
                <div class="sub-menu">
                  ...
                  <li class="has-sub expand" :class="{ active: /^\/meeting(\/.*)?$/.test(route.path) }" v-if="
                    [
                      '最高管理員',
                      '次等管理員',
                      '行政主管',
            ...
            <li class="has-sub expand" :class="{ active: /^\/salary(\/.*)?$/.test(route.path) }">
              ...
              <ul class="collapse" id="salary" data-parent="#sidebar-menu">
                <div class="sub-menu">
                  <li :class="{ active: route.path === '/salary/all' }" v-if="
                  ...
                  <li :class="{ active: route.path === '/salary/monthly' }" v-if="
                    ['最高管理員', '次等管理員', '人資主管'].includes(
                      user.roleName
                    )
                  ">
    ...
    <div class="page-wrapper">
      ...
      <header class="main-header" id="header">
        <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
          ...
          <span class="page-title">{{ pageTitle }}
